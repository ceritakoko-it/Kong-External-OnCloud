...
LOCAL_SECRET_FILE="${SCRIPT_DIR}/uat-oncloud-secrets.local.sh"
...
export PUBLIC_HOST_PRIMARY='uat-connect.kaotim.my'
...
bash "${SCRIPT_DIR}/run-oncloud-smoke-test.sh" uat
